...
import {
  resetPasswordApi,
  resetPasswordVendorApi,
  sendVerificationCodeVendorApi,
  verifyOtpForForgotPasswordVendorApi,
...
export default function VendorForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const data = await sendVerificationCodeVendorApi(email);
  ...
  const handleVerify = async (otp) => {
    try {
      const response = await verifyOtpForForgotPasswordVendorApi(email, otp);
  ...
  const handleResetPassword = async (e) => {
    ...
    setPasswordError("");
    try {
      const response = await resetPasswordVendorApi(email, password);
      if (response.status === "success") {
