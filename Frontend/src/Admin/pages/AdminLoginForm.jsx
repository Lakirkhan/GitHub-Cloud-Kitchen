...
export default function AdminLoginForm({ onSubmit, isLoading }) {
  ...
  return (
    <div className="w-full flex items-center justify-center mt-28">
      <div className="w-full max-w-md rounded-2xl -mt-25">
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {isLoading ? "Loading..." : <LogIn size={18} />} Login as Admin
          </button>
        </form>
